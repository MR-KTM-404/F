...
\033[1;91m[\033[1;92m✔︎\033[1;91m]\033[1;92m\x1b[1;92m ᴠᴇʀᴤɪᴏɴ       <>\033[1;32m  0.1\033[1;32m
...
def main_menu():
    os.system("clear")
    print(logo);lin3()
    print(f"\033[1;91m[\033[1;92m1\033[1;91m]\033[1;92m FF UID HACK")
    print(f"\033[1;91m[\033[1;92m2\033[1;91m]\033[1;92m FACEBOOK HACK  ")
    print(f"\033[1;91m[\033[1;92m3\033[1;91m]\033[1;92m PUBLIC  CLONE ")
    print(f"\033[1;91m[\033[1;92m4\033[1;91m]\033[1;92m GMAIL HACK ")
    lin3()
    cp =input('[<>] CHOICE : ')
    if cp=="1":file()
    if cp == "0":
...
def file():
    os.system("clear")
    print(logo);lin3()
    file = input(f"{oo('-')}Enter uid: ")
    try:
        for x in open(file,'r').readlines():
            idx.append(x.strip())
    except:
        print(f"{oo('!')}file make done");time.sleep(1)
        main_menu() 
    method()
    exit()
